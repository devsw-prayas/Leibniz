...
namespace Leibniz::Vectorization::Traits {
	...
	struct LEIBNIZ_RUNTIME_API ImplementationType final {
		static constexpr size_t s_Width = 0;
		static constexpr size_t s_Alignment = 0;
	};

	template<VectorizationBackend Backend>
	inline constexpr LEIBNIZ_RUNTIME_API size_t VectorizationWidth = ImplementationType<Backend>::s_Width;

	template<VectorizationBackend Backend>
	inline constexpr LEIBNIZ_RUNTIME_API size_t VectorizationAlignment = ImplementationType<Backend>::s_Alignment;

	template<>
	struct LEIBNIZ_RUNTIME_API ImplementationType<VectorizationBackend::AVX2> final{
		static constexpr size_t s_Width = 256;
		static constexpr size_t s_Alignment = 32;
	};

	template<typename T, typename = void>
	struct LEIBNIZ_RUNTIME_API VectorizeType final {
		using type = void;
	};
	...
	template<typename T, typename = void>
	struct LEIBNIZ_RUNTIME_API VectorizeMaskType final {
		using type = void;
	};
	...
	template<typename T, typename = void>
	struct LEIBNIZ_RUNTIME_API ScalarType final {
		using type = void;
	};
	...
	template<typename T, typename = void>
	struct LEIBNIZ_RUNTIME_API IsVectorStripe final : std::false_type {};
	...
	struct LEIBNIZ_RUNTIME_API VectorizationIntrospect final {
		static constexpr size_t s_Alignment = 0;
