...
namespace Leibniz::Vectorization::Intrinsic::v128 {
	...
	LEIBNIZ_FORCEINLINE LEIBNIZ_NODISCARD_MSG("Vector functions cannot have their return values discarded")
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Vector functions cannot have their return values discarded")
		r128i zero() {
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Vector loads cannot have their return values discarded")
...
// low 16 bits of signed multiplication
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Predicate extraction results must not be discarded")
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Vector test results must not be discarded")
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Vector bitwise results must not be discarded")
...
// logical left shift
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Vector sign results must not be discarded")
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Vector absolute value results must not be discarded")
		r128i abs8(r128i v) {
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Vector math results must not be discarded")
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Scalar math results must not be discarded")
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Vector packing results must not be discarded")
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Vector conversion results must not be discarded")
	...
	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Scalar conversion results must not be discarded")
	...
	LEIBNIZ_FORCEINLINE r128f64 cast(r128f32 v) { return _mm_castps_pd(v); }
	LEIBNIZ_FORCEINLINE r128f32 cast(r128f64 v) { return _mm_castpd_ps(v); }

	LEIBNIZ_FORCEINLINE r128i  castInt(r128f32 v) { return _mm_castps_si128(v); }
	LEIBNIZ_FORCEINLINE r128f32 castFloat(r128i v) { return _mm_castsi128_ps(v); }

	LEIBNIZ_FORCEINLINE r128i  castInt(r128f64 v) { return _mm_castpd_si128(v); }
	LEIBNIZ_FORCEINLINE r128f64 castDouble(r128i v) { return _mm_castsi128_pd(v); }

	LEIBNIZ_FORCEINLINE
		LEIBNIZ_NODISCARD_MSG("Vector FMA results must not be discarded")
