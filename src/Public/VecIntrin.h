...
#ifdef ALLOW_FULL_VECTOR_INTRIN
#include <v128Intrin.h>
#include <v256Intrin.h>
#elif defined(ALLOW_VECTOR_INTRIN_256)
#include <v256Intrin.h>
#elif defined(ALLOW_VECTOR_INTRIN_128)
#include <v128Intrin.h>
#else
#error "Vector intrinsics disabled. Define ALLOW_VECTOR_INTRIN_128, ALLOW_VECTOR_INTRIN_256, or ALLOW_FULL_VECTOR_INTRIN."
#endif

#if (defined(ALLOW_VECTOR_INTRIN_128) + defined(ALLOW_VECTOR_INTRIN_256) + defined(ALLOW_FULL_VECTOR_INTRIN)) > 1
#error "Multiple vector intrinsic modes defined. Choose exactly one."
#endif
...
#ifndef VEC_INTRIN
#if !defined(LEIBNIZ_EDITOR_MODE) && !defined(__AVX2__)
#define VEC_INTRIN 0
...
#if defined(LEIBNIZ_ENABLE_AVX512)
#ifndef __AVX512F__
#error "LEIBNIZ_ENABLE_AVX512 is set, but compiler target does not support AVX-512F"
#endif
#define LEIBNIZ_HAS_AVX512 1
#else
#define LEIBNIZ_HAS_AVX512 0
#endif

#ifndef VEC512_INTRIN
#if defined(LEIBNIZ_ENABLE_AVX512)
#if !defined(LEIBNIZ_EDITOR_MODE) && LEIBNIZ_HAS_AVX512 == 0
#define VEC512_INTRIN 0
#error "AVX-512 backend enabled but not supported by compiler"
#else
#define VEC512_INTRIN 1
#endif
#else
#define VEC512_INTRIN 0
#endif
...
#ifdef ALLOW_WIDE_VECTOR_INTRIN
#if VEC512_INTRIN
#include <b512Intrin.h>
#endif
#endif
